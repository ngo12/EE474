...
{  
  ...
  axMapped = map(ax*1000,-2000,2000,30,240);
  ayMapped = map(ay*1000,-2000,2000,30,240);
  azMapped = map(az*1000,-2000,2000,30,240);
  gxMapped = map(gx,-250,250,30,240);
  gyMapped = map(gy,-250,250,30,240);
  gzMapped = map(gz,-250,250,30,240);
  ...
  if(deltat > 100) {
    ...
    tft.fillRect(30,3,axMapped,50,ILI9341_RED);
    tft.fillRect(30,56,ayMapped,50,ILI9341_GREEN);
    tft.fillRect(30,109,azMapped,50,ILI9341_BLUE);
    tft.fillRect(30,162,gxMapped,50,ILI9341_YELLOW);
    tft.fillRect(30,215,gyMapped,50,ILI9341_PINK);
    tft.fillRect(30,268,gzMapped,50,ILI9341_ORANGE);
