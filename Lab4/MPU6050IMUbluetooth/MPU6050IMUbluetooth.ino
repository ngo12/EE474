...
void RenderImage( void)
{
  ...
  {
    tft.drawLine(Render[i].p0.x,Render[i].p0.y,Render[i].p1.x,Render[i].p1.y, ILI9341_GREEN);
  }
...
//    PIX.blue = angle_to_channel(angle-4*PI/3)>>1;
    ...
    Xan = map(x*100,-100,100,-180,180);
    Yan = map(y*100,-100,100,-180,180);
    Zan = -map(z*100,-100,100,-180,180);
  Serial.print("Xan = ");
  Serial.println(Xan);
//    map(w,-1,1,-180,180);
//    Xan = axAvg;
