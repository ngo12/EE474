...
{  
  ...
  axArray[countera] = map(ax*1000,-2000,2000,30,240);
  ayArray[countera] = map(ay*1000,-2000,2000,30,240);
  azArray[countera] = map(az*1000,-2000,2000,30,240);
  gxArray[counterg] = map(gx,-250,250,30,240);
  gyArray[counterg] = map(gy,-250,250,30,240);
  gzArray[counterg] = map(gz,-250,250,30,240);
  ...
  if(deltat > 100) {
    ...
    tft.setTextColor(ILI9341_RED);  // Labels the x-axis acceleration 
    tft.setCursor(0,23);
    tft.print("AX");
    ...
    tft.fillRect(30,3,arrayAverage(axArray,na),50,ILI9341_RED);
    tft.fillRect(30,56,arrayAverage(ayArray,na),50,ILI9341_GREEN);
    tft.fillRect(30,109,arrayAverage(azArray,na),50,ILI9341_BLUE);
    tft.fillRect(30,162,arrayAverage(gxArray,ng),50,ILI9341_YELLOW);
    tft.fillRect(30,215,arrayAverage(gyArray,ng),50,ILI9341_PINK);
    tft.fillRect(30,268,arrayAverage(gzArray,ng),50,ILI9341_ORANGE);
