...
//    Serial.print("average rate = "); Serial.print(1.0f/deltat, 2); Serial.println(" Hz");
    ...
    yawArray[countera] = map(yaw,-180,180,30,240);
    pitchArray[countera] = map(pitch,-180,180,30,240);
    rollArray[countera] = map(roll,-180,180,30,240);
  ...
  if(counterg >= ng-1) {
    ...
    tft.fillRect(30,3,arrayAverage(yawArray,na),50,ILI9341_RED);
    tft.fillRect(30,56,arrayAverage(pitchArray,na),50,ILI9341_GREEN);
    tft.fillRect(30,109,arrayAverage(rollArray,na),50,ILI9341_BLUE);
