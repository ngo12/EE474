...
{  
  ...
  axArray[countera] = map(ax*1000,-2000,2000,0,360);
  ayArray[countera] = map(ay*1000,-2000,2000,0,360);
  azArray[countera] = map(az*1000,-2000,2000,0,255);
  gxArray[counterg] = map(gx,-250,250,-250,250);
  gyArray[counterg] = map(gy,-250,250,-250,250);
  gzArray[counterg] = map(gz,-250,250,-250,250);
...
/***********************************************************************************************************************************/
    val = analogRead(2)/4;
    axAvg = arrayAverage(axArray,na);
    ayAvg = arrayAverage(ayArray,na);
    azAvg = arrayAverage(azArray,na);
    gxAvg = arrayAverage(gxArray,ng);
    gyAvg = arrayAverage(gyArray,ng);
    gzAvg = arrayAverage(gzArray,ng);
